...
function Clothes1() {
    const donRequests = [
        { image: Clothes, name: "Shirt", category: "Clothes", linkTo:"/clothesdetails1"},
        { image: Clothes, name: "Jeans", category: "Clothes", linkTo:"/clothesdetails1" }
    ];

    // Filter requests based on certain criteria

    return (
      <div className="clothes1list">
        <Navbar />
        <FilterBar/>
