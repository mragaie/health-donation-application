...
function TeachingMath() {

    const donRequests = [
        {  image: School, name: "Math Teacher", category: "Teaching Posts", linkTo:"/teachingdetails"},
    ];

    return (
      <div className="teachingmath">
        <TeacherNavBar />
        <FilterBarTeaching/>
