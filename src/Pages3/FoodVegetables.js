...
function Food() {
    ...
    const filteredRequests = [
        { image: Foodd, name: "Cucumber", category: "Food", linkTo:"/foodvegetablesdetails" },
        { image: Foodd, name: "Bell Pepper", category: "Food", linkTo:"/foodvegetablesdetails" }
    ];

    return (
      <div className="foodvegetables">
        <Navbar />
        <FilterBarFood/>
