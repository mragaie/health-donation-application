...
function Food() {
    ...
    const filteredRequests = [
        { image: Foodd, name: "Ceasar Salad", category: "Food", linkTo:"/foodfreshdetails" },
        { image: Foodd, name: "Greek Salad", category: "Food", linkTo:"/foodfreshdetails" }
    ];

    return (
      <div className="foodfresh">
        <Navbar />
        <FilterBarFood/>
