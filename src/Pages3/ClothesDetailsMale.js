...
function ClothesDetailsMale() {
    const donRequests = [
        { gender: "Male", season: "Winter",  material: "Wool", quantity: "3", age: "13 years", category: "Clothes" },
    ];

    // Filter requests based on certain criteria

    return (
      <div className="clothesdetailsmale">
        <Navbar />
        <FilterBar/>
...
export default ClothesDetailsMale
