...
function Clothes13() {
    const donRequests = [
        { image: Clothes, name: "Hoodie", category: "Clothes", linkTo:"/clothesdetailsmale" },
        { image: Clothes, name: "Jacket", category: "Clothes", linkTo:"/clothesdetailsmale" }
    ];

    // Filter requests based on certain criteria

    return (
      <div className="clothes13list">
        <Navbar />
        <FilterBar/>
