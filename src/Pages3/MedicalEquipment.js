...
function MedicalEquipment() {
    ...
    const filteredRequests = [
        {image:Medicall,  name: "syringes 3ml", category: "Medical Supplies", linkTo:"/medicaldetails2" },
        { image:Medicall, name: "syringes 5ml", category: "Medical Supplies", linkTo:"/medicaldetails2" }
    ];
